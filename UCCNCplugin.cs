...
namespace Plugins
{
    public class UCCNCplugin //Class name must be UCCNCplugin to work! 
    {
        ...
        {
            Properties.author = "Mikrofabriken";
            Properties.pluginname = "BigDisplay"; 
        ...
        public void Loop_event() 
        {
            ...
            try
            {
                myform.DisplayX.Text = UC.Getfield(true, 226);
                myform.DisplayY.Text = UC.Getfield(true, 227);
                myform.DisplayZ.Text = UC.Getfield(true, 228);
                myform.DisplayF.Text = UC.Getfield(true, 868);
            }
            catch (Exception) { }
        ...
        public object Informplugin_event(object Message)
        {
            if (!(myform == null || myform.IsDisposed))
            {
                if (Message is string)
                {
                    ...
                    MessageBox.Show(this.myform, "Informplugin message received by Big Display! Message was: " + receivedstr);
                }
            }
        ...
        public void Informplugins_event(object Message)
        {
            ...
            {
                string receivedstr = Message as string;
                MessageBox.Show(this.myform, "Informplugins message received by Big Display! Message was: " + receivedstr);
            }
        }
